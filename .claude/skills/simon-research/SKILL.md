---
name: simon-research
description: 플래닝 전 외부 리서치 의무화 — 공식 문서·경쟁 제품·레퍼런스 수집. Research-first principle from ECC — mandatory external research before planning, with citation and source discipline. 트리거 키워드 — 리서치, research, 조사, 선행 학습, 경쟁 분석, 기술 비교, 레퍼런스 수집, 기술 스택 검토, 시장 조사.
