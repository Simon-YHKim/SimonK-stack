...
export const en: Record<keyof typeof ko, string> = {
  ...
  resetCreditConfirmBody: 'Use one of {count} banked resets for {account} ({email})? This refreshes the 5-hour and weekly limits and may move the weekly reset time. Expires: {expiry}',
  resetCreditExpiryUnknown: 'unknown',
  resetCreditCancelled: 'Reset use cancelled.',
  resetCreditSuccess: 'Reset used. Refreshing usage.',
  resetCreditUnavailable: 'Could not verify this account or reset details. Check the official usage page.',
  resetCreditNothingToReset: 'There is no limit to reset now.',
