...
TAGS = {
    'LLM': ['LLM', 'GPT', 'Claude', 'Gemini', 'Qwen', 'DeepSeek', 'Llama', 'Mistral', 'Grok', 'GLM', '언어모델', '대형 언어', 'Mixtral'],
    'RAG': ['RAG', 'retrieval', 'augmented', '검색 증강', '벡터DB', 'pinecone', 'chroma', 'qdrant', 'weaviate'],
    'Agent': ['agent', 'Agent', '에이전트', 'autonomous', '자율', 'AutoGPT', 'CrewAI', 'LangGraph', 'multi-agent'],
    'Vision': ['vision', 'image', '이미지', '비전', 'OCR', 'segmentation', 'detection', '이미지 생성', 'Stable Diffusion', 'SDXL', 'FLUX', 'ControlNet', 'Midjourney', 'DALL-E'],
    'Video': ['video', '비디오', '영상', 'Sora', 'Runway', 'Pika', 'animatediff', 'V2V', 'AnimateDiff'],
    'Audio_Music': ['audio', 'music', '음악', '음성', 'TTS', 'STT', 'Whisper', 'Suno', 'Udio', 'MusicGen', 'voice', '보컬'],
    'Avatar_3D': ['avatar', '아바타', '3D', 'NeRF', 'gaussian', 'mesh', 'rigging', 'character'],
    'Code_AI': ['code', 'coding', '코드', '개발', 'Copilot', 'Codex', 'Cursor', 'Cline', 'Aider', 'Devin', 'SWE'],
    'MCP': ['MCP', 'Model Context Protocol'],
    'Local_LLM': ['Ollama', 'LM Studio', 'llama.cpp', '로컬', 'local', 'quantization', 'GGUF', 'GGML', 'on-device'],
    'Tool_Workflow': ['워크플로', 'workflow', '자동화', 'automation', 'n8n', 'ComfyUI', 'Make', 'Zapier'],
    'Training_Finetune': ['fine-tuning', 'finetune', '파인튜닝', 'LoRA', 'PEFT', '학습', 'training', 'RLHF', 'DPO'],
    'Reasoning': ['reasoning', '추론', 'CoT', 'chain of thought', 'o1', 'o3', 'thinking', 'reflection'],
    'Robotics': ['robot', 'robotics', '로봇', 'embodied', 'manipulation'],
    'Game_AI': ['game', '게임', 'NPC', 'Unity', 'Unreal'],
    'API_Service': ['API', 'service', '서비스', 'OpenRouter', 'together.ai', 'Groq', 'Cerebras'],
    'Benchmark_Eval': ['benchmark', 'eval', '평가', 'MMLU', 'SWE-bench', 'HLE', 'GPQA', '리더보드', 'leaderboard'],
    'Hardware_GPU': ['GPU', 'NVIDIA', 'CUDA', 'A100', 'H100', 'B200', '하드웨어', 'Apple Silicon', 'M3', 'M4'],
    'Korean': ['한국어', '한글', 'KoBALT', 'Naver', '네이버', 'Kakao', '카카오', 'LG AI Research', 'EXAONE'],
}
